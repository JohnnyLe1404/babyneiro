...
export default function Div3() {
  return (
    <div
    name="div3"
     className="bg-[url('/image/moon3.1.png')] md:bg-[url('/image/moon3.png')] py-20 bg-cover bg-center bg-[#E3E0DA] min-w-screen min-h-screen flex flex-col justify-center items-center">
