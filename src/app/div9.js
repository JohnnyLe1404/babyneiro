...
const Div9 = () => {
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1300px] mt-8 flex justify-center md:justify-start space-x-4 sm:space-x-8 md:space-x-16 items-center border-b-2 border-opacity-50 border-white pb-4">
        <div className="flex space-x-16 sm:space-x-32 md:space-x-8 justify-center items-center">
          <a
