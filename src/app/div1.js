  ...
  return (
    ...
    >
      ...
      <header className="w-full max-w-full justify-between mx-auto flex items-center p-4 bg-black bg-opacity-60 z-50">
        <div className={`flex items-center space-x-2 ${isMenuOpen ? "" : "md:ml-44"}`}>
          <Image
            src="/image/logo.png"
            alt="Neiro Logo"
            width={50}
            height={50}
          />
          <span className="text-2xl md:text-4xl font-bold text-white">NEIRO</span>
        </div>
        ...
        <nav className="hidden md:flex justify-center space-x-4 lg:space-x-28 text-lg lg:text-2xl text-white">
          ...
          <a href="#" className="hover:text-gray-300">Tokenomics</a>
          <a href="#" className="hover:text-gray-300">Whitepaper</a>
          <a href="#" className="hover:text-gray-300">Socials</a>
        </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden w-full bg-black bg-opacity-90 text-white">
          <nav className="flex flex-col items-center py-4 space-y-4 text-xl">
            ...
            <a href="#" className="hover:text-gray-300">Whitepaper</a>
            <a href="#" className="hover:text-gray-300">Socials</a>
            <button className="border border-white rounded-full px-4 py-2 hover:bg-gray-600 text-xl text-white">
              Join Telegram
            </button>
          </nav>
        </div>
      ...
      <div className="flex flex-col items-center mt-12 md:mt-44 md:ml-72 text-center px-4 md:px-0">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-100 mb-6 text-base md:text-lg px-4 md:px-0">
            The First BabyNeiro on ETHEREUM, managed by community with all our hearts
          </p>
